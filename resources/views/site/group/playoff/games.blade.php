                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            @if (!is_null($pair) && $pair->teamOne && count($pair->games))
                                                ...
                                                <span
                                                    class="badge bg-success ml-1">{{ $pair->teamOne->short_name }}</span>
                                            @else
                                                <select class="form-select form-control-sm" name="team_one_id">
                                                    <option value="">--</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            @if (!is_null($pair) && $pair->teamTwo && count($pair->games))
                                                ...
                                                <span
                                                    class="badge bg-success ml-1">{{ $pair->teamTwo->short_name }}</span>
                                            @else
                                                <select class="form-select form-control-sm" name="team_two_id">
                                                    <option value="">--</option>
                                                    @foreach($tournament->teams as $team)
                                                        <option value="{{ $team->id }}"
