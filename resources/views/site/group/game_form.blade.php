...
@section('content')
    ...
    <form id="game-form">
        ...
        <table class="mb-2 w-100">
            <tbody>
            <tr>
                <td class="text-end pr-3 w-50">
                    <h2>{{ $pair ? $pair->teamOne->name : $game->homeTeam->team->name }}</h2>
                </td>
                <td class="px-3"></td>
                <td class="text-start pl-3 w-50">
            ...
            <tr>
                <td class="text-end">
                    <input
                        ...
                        type="number"
                        id="home_score"
                        class="form-control form-control-lg text-center float-end"
                        name="home_score"
                ...
                <td class="text-start">
                    <input
                        ...
                        type="number"
                        id="away_score"
                        class="form-control form-control-lg text-center float-start"
                        name="away_score"
        ...
        <div class="row row-cols-lg-auto g-2 align-items-center justify-content-center mb-2">
            <div class="col-12">
                <div class="form-check">
                    <input type="checkbox" id="isOvertime" class="form-check-input" name="isOvertime"
                           @if($game && $game->isOvertime) checked @endif>
                    <label class="form-check-label" for="isOvertime">Овертайм</label>
                </div>
            </div>
            <div class="col-12">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="isTechnicalDefeat"> Техническое поражение</label>
                </div>
            </div>
        </div>
        <div class="row row-cols-lg-auto g-2 align-items-center justify-content-center">
            <div class="col-12">
                <div class="input-group">
                    <label class="input-group-text" for="playedAt">Дата игры</label>
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                <input type="number" id="home_shot" class="form-control text-end" name="home_shot"
                       value="{{ $game ? $game->home_shot : '' }}" {{ $game && $game->match_id ? 'readonly' : '' }}>
            </div>
            <div class="col-3 text-center"><strong>Всего бросков</strong></div>
            <div class="col">
                <input type="number" id="away_shot" class="form-control text-end" name="away_shot"
        ...
        <div class="row mt-1">
            <div class="col-1 col-md-2 col-xl-3"></div>
            <div class="col">
                <input type="number" id="home_hit" class="form-control text-end" name="home_hit"
                       value="{{ $game ? $game->home_hit : '' }}" {{ $game && $game->match_id ? 'readonly' : '' }}>
            </div>
            <div class="col-3 text-center"><strong>Силовые</strong></div>
            <div class="col">
                <input type="number" id="away_hit" class="form-control text-end" name="away_hit"
        ...
        <div class="row mt-1">
            <div class="col-1 col-md-2 col-xl-3"></div>
            <div class="col">
                <input type="text" id="home_attack_time" class="form-control text-end" name="home_attack_time"
            ...
            <div class="col">
                <input type="text" id="away_attack_time" class="form-control text-end" name="away_attack_time"
        ...
        <div class="row mt-1">
            <div class="col-1 col-md-2 col-xl-3"></div>
            <div class="col">
                <input type="text" id="home_pass_percent" class="form-control text-end" name="home_pass_percent"
            ...
            <div class="col">
                <input type="text" id="away_pass_percent" class="form-control text-end" name="away_pass_percent"
        ...
        <div class="row mt-1">
            <div class="col-1 col-md-2 col-xl-3"></div>
            <div class="col">
                <input type="number" id="home_faceoff" class="form-control text-end" name="home_faceoff"
            ...
            <div class="col">
                <input type="number" id="away_faceoff" class="form-control text-end" name="away_faceoff"
        ...
        @if (($pair && $pair->tournament->min_players === 6) || ($game && $game->tournament->min_players === 6))
            <div class="row mt-1">
                <div class="col-1 col-md-2 col-xl-3"></div>
                <div class="col">
                    <input id="home_penalty_time" class="form-control text-end"
                ...
                <div class="col">
                    <input id="away_penalty_time" class="form-control text-end"
            ...
            <div class="row mt-1">
                <div class="col-1 col-md-2 col-xl-3"></div>
                <div class="col">
                    <input type="number" id="home_penalty_success" class="form-control text-end float-start w-50"
                           name="home_penalty_success" {{ $game && $game->match_id ? 'readonly' : '' }}
                           value="{{ $game ? $game->home_penalty_success : '' }}">
                    <input type="number" id="home_penalty_total" class="form-control text-end w-50"
                ...
                <div class="col">
                    <input type="number" id="away_penalty_success" class="form-control text-end float-start w-50"
                           name="away_penalty_success" {{ $game && $game->match_id ? 'readonly' : '' }}
                           value="{{ $game ? $game->away_penalty_success : '' }}">
                    <input type="number" id="away_penalty_total" class="form-control text-end w-50"
            ...
            <div class="row mt-1">
                <div class="col-1 col-md-2 col-xl-3"></div>
                <div class="col">
                    <input id="home_powerplay_time" class="form-control text-end"
                ...
                <div class="col">
                    <input id="away_powerplay_time" class="form-control text-end"
            ...
            <div class="row mt-1">
                <div class="col-1 col-md-2 col-xl-3"></div>
                <div class="col">
                    <input type="number" id="home_shorthanded_goal" class="form-control text-end"
                ...
                <div class="col">
                    <input type="number" id="away_shorthanded_goal" class="form-control text-end"
