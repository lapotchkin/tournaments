...
Date.prototype.getShortDate = function () {
  ...
  var day = _.padStart(this.getDate().toString(), 2, '0');

  var month = _.padStart((this.getMonth() + 1).toString(), 2, '0');
...
Date.prototype.getFullDate = function () {
  ...
  var hour = _.padStart(this.getHours().toString(), 2, '0');

  var minute = _.padStart(this.getMinutes().toString(), 2, '0'); // let second = _.padStart(this.getSeconds().toString(), 2, '0');
...
/* harmony default export */ __webpack_exports__["default"] = (function (params) {
  ...
  $(document).on('click', params.selector, function (e) {
    ...
    var url = id ? params.url + '/' + id : params.url;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  convertTimeStringToSeconds: function convertTimeStringToSeconds(time) {
    var tmp = time.split(':');
    var seconds = 0;

    for (var i = 0; i < tmp.length; i += 1) {
      var multiplier = 60 * -(i + 1 - tmp.length);
